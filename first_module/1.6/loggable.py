...
У него есть ровно один метод log, который позволяет выводить в лог (в данном
случае в stdout) какое-то сообщение, добавляя при этом текущее время.
...
class LoggableList(list, Loggable):
    def append(self, message):
        ...
        self.log(message)
        return super(LoggableList, self).append(message)
